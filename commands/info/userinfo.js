...
module.exports = {
  ...
  description: "Muestra la info de un miembro",
  ...
  run: async (client, message, args) => {
    ...
    const embed = new MessageEmbed()
      ...
      .addField("Se ha unido el ", member.joinedAt.toDateString())
      .addField("Se ha creado una cuenta del discord el", member.user.createdAt.toDateString())
